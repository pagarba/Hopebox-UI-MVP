...
module.exports = Object.assign({}, base, {
  devServer: Object.assign({}, base.devServer, {
    contentBase: PROD ? path.join(__dirname, 'docs', 'web') : path.join(__dirname, 'assets'),
  }),
  entry: ['whatwg-fetch', path.join(__dirname, 'web', 'index.js')],
  ...
  plugins: [
    ...
    new htmlPlugin({
      ...
      inject: 'body',
      base: PROD ? 'https://pagarba.github.io/Hopebox-UI-MVP/web/' : 'http://localhost:8080/web/',
      minify: PROD,
      hash: true,
      xhtml: true,
    }),
